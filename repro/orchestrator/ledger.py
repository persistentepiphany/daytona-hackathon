...
class Ledger:
    def __init__(self, path: str | Path):
        ...
        # The RLock above only serializes threads; concurrent pipelines are separate
        # processes sharing this file, so WAL plus a patient busy timeout is what
        # keeps a contended write from raising 'database is locked'.
